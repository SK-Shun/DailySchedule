...
class ScheduleServiceImplTest {
    ...
    void create_shouldCreateSchedule_whenValidInput() {
        ...
        ScheduleEntry result = service.create(
                slug, TaskType.WORK, 540, 600, "  勉強する  "
        );

        assertThat(result.getSheet()).isSameAs(sheet);
        assertThat(result.getType()).isEqualTo(TaskType.WORK);
        assertThat(result.getStartMin()).isEqualTo(540);
        assertThat(result.getEndMin()).isEqualTo(600);
        assertThat(result.getMemo()).isEqualTo("勉強する");
    ...
    void create_shouldTrimMemo_whenMemoHasWhitespace() {
        ...
        assertThat(result.getMemo()).isEqualTo("遊ぶ");
    }
    ...
    void create_shouldSetEmptyMemo_whenMemoIsNull() {
        ...
        assertThat(result.getMemo()).isEqualTo("");
    }
