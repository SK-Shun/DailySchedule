...
class ScheduleSheetServiceImplTest {
    ...
    void createSheet_shouldTrimTitleAndGenerateSlug() {
        ...
        ScheduleSheet result = service.createSheet("  My Schedule  ");

        assertThat(result.getTitle()).isEqualTo("My Schedule");
        assertThat(result.getSlug()).isEqualTo("my-schedule");

        ArgumentCaptor<ScheduleSheet> captor = ArgumentCaptor.forClass(ScheduleSheet.class);
    ...
    void createSheet_shouldAppendNumberWhenSlugAlreadyExists() {
        ...
        assertThat(result.getSlug()).isEqualTo("my-schedule-2");
    }
    ...
    void createSheet_shouldFallbackToDefaultSlugWhenNormalizedIsBlank() {
        ...
        ScheduleSheet result = service.createSheet("あいうえお");

        assertThat(result.getTitle()).isEqualTo("あいうえお");
        assertThat(result.getSlug()).isEqualTo("sheet");
    }
